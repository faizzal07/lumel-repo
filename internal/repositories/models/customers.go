...
type Customer struct {
	...
	CustomerAddress null.String `boil:"customer_address" json:"customer_address,omitempty" toml:"customer_address" yaml:"customer_address,omitempty"`
...
var CustomerWhere = struct {
	...
	CustomerAddress whereHelpernull_String
}{
	CustomerID:      whereHelperint{field: "\"customers\".\"customer_id\""},
	CustomerName:    whereHelpernull_String{field: "\"customers\".\"customer_name\""},
	CustomerEmail:   whereHelpernull_String{field: "\"customers\".\"customer_email\""},
	CustomerAddress: whereHelpernull_String{field: "\"customers\".\"customer_address\""},
}
...
var (
	customerAllColumns            = []string{"customer_id", "customer_name", "customer_email", "customer_address"}
	customerColumnsWithoutDefault = []string{}
	customerColumnsWithDefault    = []string{"customer_id", "customer_name", "customer_email", "customer_address"}
...
func (o *Customer) AddOrdersG(ctx context.Context, insert bool, related ...*Order) error {
...
func (o *Customer) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
