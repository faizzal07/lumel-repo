...
func testOrderToOneCustomerUsingCustomer(t *testing.T) {
	...
	AddCustomerHook(boil.AfterSelectHook, func(ctx context.Context, e boil.ContextExecutor, o *Customer) error {
...
var (
	orderDBTypes = map[string]string{`OrderID`: `integer`, `CustomerID`: `integer`, `ProductID`: `integer`, `DateOfSale`: `date`, `QuantitySold`: `integer`, `UnitPrice`: `numeric`, `Discount`: `numeric`, `ShippingCost`: `numeric`, `PaymentMethod`: `character varying`, `Region`: `character varying`}
	_            = bytes.MinRead
)
