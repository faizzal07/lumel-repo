...
var ProductWhere = struct {
	...
	ProductName: whereHelpernull_String{field: "\"products\".\"product_name\""},
...
var (
	productAllColumns            = []string{"product_id", "product_name", "category"}
	productColumnsWithoutDefault = []string{}
	productColumnsWithDefault    = []string{"product_id", "product_name", "category"}
...
func (o *Product) Orders(mods ...qm.QueryMod) orderQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"orders\".\"product_id\"=?", o.ProductID),
	)
...
func (o *Product) AddOrdersG(ctx context.Context, insert bool, related ...*Order) error {
...
func (o *Product) AddOrders(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Order) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.ProductID, rel.OrderID}
...
func FindProductG(ctx context.Context, productID int, selectCols ...string) (*Product, error) {
...
func ProductExistsG(ctx context.Context, productID int) (bool, error) {
